...
namespace AppMicroondas.ViewModels
{
    public class MainPageViewModel : ViewModelBase
    {
        ...
        public ObservableCollection<Program> ProgramsList { get; set; } = new ObservableCollection<Program>();
        public ObservableCollection<Program> SearchResults { get; }
        ...
        // PROPRIEDADE QUE IRÁ INFORMAR A VIEW A RESPEITO DA STRING FOODSTRING 
        ...
        public Program SelectedProgram
        {
            ...
            set
            {
                if (_selectedProgram != value)
                {
                    ...
                    {
                        App.Current.MainPage.DisplayAlert("Alerta", "Alimento incompativel com o programa selecionado", "OK");
                    }
                }
            }
        }
        ...
        {
            /*
              VERIFICO SE NA STRING QUE FOI PASSADA PELO USUÁRIO
              CONTÉM ALGUMA PALAVRA REFERENTE AO PROGRAMA A SER UTILIZADO
              CASO NÃO CONTENHA LANÇAR A EXCEÇÃO 
             */ 
    ...
    public MainPageViewModel(INavigationService navigationService) : base(navigationService)
        ...
        private async void ExecuteSearchCommand()
        {
            ...
            {
                await App.Current.MainPage.DisplayAlert("Resultados", "Nenhum resultado encontrado.", "OK");
                return;
            }
        ...
        /* MÉTODO PARA A EXECUÇÃO DO TEMPO EM MODO LIGADO */
